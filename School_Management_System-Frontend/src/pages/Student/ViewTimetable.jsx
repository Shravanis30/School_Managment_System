...
// //   //       setTimetable(data.entries); // Make sure this matches the response structure
// //   //     } catch (error) {
...
// //   const fetchStudentTimetable = async () => {
// //     try {
// //       // Ensure studentClass is available
// //       if (!studentClass) {
// //         throw new Error("Student class not available");
// //       }
...
// //   // Add this useEffect to fetch student class first
// //   useEffect(() => {
...
// //   // Add this useEffect to call fetchStudentTimetable when studentClass changes
// //   useEffect(() => {
// //     if (studentClass) {
// //       fetchStudentTimetable();
// //     }
...
//                     <th className="p-3">Day</th>
//                     {[...Array(6)].map((_, i) => (
//                       <th key={i} className="p-3">Period {i + 1}</th>
//                     ))}
//                   </tr>
//                 </thead>
//                 <tbody>
...
//                       {entry.periods.map((p, idx) => (
//                         <td key={idx} className="p-3">{p || 'Free'}</td>
//                       ))}
//                     </tr>
//                   ))}
//                 </tbody>
