...
//   const studentClass = localStorage.getItem('studentClassId');

//   useEffect(() => {
//     const fetchResourcesAndSubjects = async () => {
//       try {
//         const [resourcesRes, classRes] = await Promise.all([
//           axios.get(`http://localhost:5000/api/resources/class/${studentClass}`),
//           axios.get(`http://localhost:5000/api/classes/${studentClass}`)
//         ]);

//         setResources(resourcesRes.data);
//         setSubjects(classRes.data.subjects || []);
//       } catch (err) {
//         console.error('Failed to fetch resources or subjects:', err);
//       }
//     };

//     if (studentClass) {
//       fetchResourcesAndSubjects();
//     }
//   }, [studentClass]);
...
//         <h2 className="text-xl font-bold mb-4">My Class Resources</h2>
...
//                 </div>
//                 <a
//                   href={`http://localhost:5000/resources/${res.fileUrl}`}
//                   target="_blank"
