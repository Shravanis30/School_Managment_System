...
//         {/* Meetings Table */}
//         <table className="w-full mb-8 text-left rounded overflow-hidden">
...
//               <tr key={i} className="bg-gray-700 text-center border-t border-gray-600">
...
//                 <td>
//                   <button onClick={() => handleMarkAsDone(i)} className="text-green-400 underline">Mark Done</button>
//                 </td>
//               </tr>
//             )) : (
//               <tr>
...
//         {/* Add Meeting Form */}
//         <div className="mb-10">
//           <h3 className="text-xl font-semibold mb-4">Schedule a New Meeting</h3>
...
//             />
//           </div>
//           <button onClick={handleAddMeeting} className="mt-4 bg-green-500 hover:bg-green-600 px-6 py-2 rounded text-black font-semibold shadow">Add Meeting</button>
//         </div>

//         {/* Meeting History (Optional Local Only) */}
//         <h2 className="text-xl font-bold mb-4">Meeting History (Local Only)</h2>
