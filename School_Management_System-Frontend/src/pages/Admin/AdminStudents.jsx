...
//             className="w-full md:w-64 bg-gray-800 text-white p-2 rounded border border-gray-700"
//           >
...
//               <tbody>
//                 {students.map((s, i) => (
//                   <tr key={s._id} className="border-t border-gray-600 hover:bg-gray-700">
//                     <td className="p-3">{i + 1}</td>
//                     <td className="p-3">{s.fullName || s.name}</td>
