...
// // import { saveMarks, getMarksByClassAndTeam } from '../controllers/marks.controller.js';
// // import authMiddleware from '../middlewares/auth.middleware.js';

// // const router = express.Router();

// // router.post("/", authMiddleware, saveMarks); // POST marks
// // router.get("/:className/:team", authMiddleware, getMarksByClassAndTeam); // Optional for fetching

// // export default router;


// import express from "express";
// import Mark from "../models/marks.model.js"; // Adjust to your actual model path
// import authMiddleware from "../middlewares/auth.middleware.js";
