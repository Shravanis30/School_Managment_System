...
// //     // Check if a document exists for this student and academic year
...
// //       });
// //     } else {
// //       // If record for the date already exists, update it
// //       const existingIndex = attendanceDoc.records.findIndex(record => record.date === date && record.subject === subject);
...
// // // GET /api/attendance/student/:studentId?year=2024-2025
...
// //     if (!doc) return res.status(404).json({ message: "No attendance found" });
...
// //       if (!attendanceDoc) {
// //         // No record exists, so we create one
...
// //         });
// //       } else {
// //         // Document exists: Check if this date+subject already exists in records
...
// //         await attendanceDoc.save(); // Save the updated document
// //       }
// //     }
